...
Webbasierte Neuimplementierung des Windows-Programms [Rechenblatt 3.1](https://www.pabst-software.de/doku.php?id=programme:rechenblatt:start) von Pabst-Software https://github.com/martin-pabst als einzelne HTML-Datei — ohne Abhängigkeiten, offline nutzbar, druckoptimiert.
